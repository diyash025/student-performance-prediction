...
## Files
- `scripts/student_prediction.py` - Python machine learning code
- `outputs/student_predictions.csv` - Data exported for Power BI
- `outputs/dashboard/student_performance_dashboard.pbix` - Power BI dashboard file
- `outputs/charts/dashboard.png` - Dashboard preview
